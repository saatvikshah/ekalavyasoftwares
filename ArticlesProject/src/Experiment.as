...
public class Experiment {
			...
			private function setupUIBackground():void{
				...
				ARadioButton.x = worldUnitX/2;
				AnRadioButton.x = worldUnitX/2;
				THERadioButton.x = worldUnitX / 2;
				AnRadioButton.y = ARadioButton.y + worldUnitY;
				THERadioButton.y = AnRadioButton.y + worldUnitY;
			}
			...
			private function setupStartText():void {
				...
				//ACTUAL TEXT
				textToFill = "'A', 'An', and 'The' are called Articles.\n There are two types of articles :\n\tIndefinite Articles—'a', 'an'\n\t'An'—Is used before nouns beginning with a vowel:\n\t(a, e, i, o, u) or having a vowel sound:\n\tExamples: an apple, an elephant, an issue, an hour\n\n\t'A'—used before nouns beginning with consonants:\n\t(other than a, e, i, o, u) or vowels sounding like consonants:\n\tExamples : a stamp, a desk, a TV, a cup, a utensil\n\n\tDefinite Article—'The'\n\tCan be used before singular and plural nouns\n\tExamples: the shoe, the belt, the car";
