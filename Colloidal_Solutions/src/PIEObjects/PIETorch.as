...
import pie.uiElements.*;
	...
	public var liqLight:PIEquadrilateral;
	...
	private var lightColour:uint = 0XFFFF66;
	private var onColour:uint = 0X99FF33;
	private var offColour:uint = 0XFF0000;
	private var liqLightColour:uint = 0XFFFF99;
		...
		private function drawLight():void {
			...
			var pt2:Point = new Point(pt1.x + unitSizeX, pt1.y - (unitSizeY/2));
			var pt3:Point = new Point(pt2.x, pt1.y + (unitSizeY*1.35));
		...
		private function drawLiqLight():void {
			var pt1:Point = new Point(aOrigin.x + unitSizeX * 4, aOrigin.y - unitSizeY/2);
			var pt2:Point = new Point(pt1.x + unitSizeX*2, pt1.y - (unitSizeY*0.8));
			var pt3:Point = new Point(pt2.x, pt1.y + (unitSizeY*2.1));
			var pt4:Point = new Point(pt1.x, pt1.y + unitSizeY * 1.7);
			liqLight = new PIEquadrilateral(pie, pt1, pt2, pt3, pt4, liqLightColour);
			liqLight.visible = false;
			pie.addDisplayChild(liqLight);
		}
